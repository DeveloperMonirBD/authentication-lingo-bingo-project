...
const Banner = () => {
    return (
        <motion.div
            ...
            className="min-h-[650px] sm:h-64 xl:h-80 2xl:h-96 px-4 lg:px-14 max-w-screen-2xl mx-auto h-screen bg-[radial-gradient(50%_50%_at_50%_50%,#17956D_0%,#0F684C_100%)] pt-0 pb-0 md:pt-20 md:pb-24 -mt-[52px] md:-mt-[40px] py-16 rounded-md ">
            <Carousel className="w-full mx-auto">
                ...
                <div className="md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-8 md:px-12">
                    ...
                    <div className="md:w-2/3">
                        <h1 className="text-3xl md:text-5xl font-semibold mb-4 text-white md:w-3/4 leading-snug">
