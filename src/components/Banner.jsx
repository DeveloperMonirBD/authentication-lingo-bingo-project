...
const Banner = () => {
    return (
        <div className="min-h-[650px] sm:h-64 xl:h-80 2xl:h-96 px-4 lg:px-14 max-w-screen-2xl mx-auto h-screen bg-[radial-gradient(50%_50%_at_50%_50%,#17956D_0%,#0F684C_100%)] pt-20 pb-24 -mt-[52px] md:-mt-[40px] py-16 rounded-md ">
