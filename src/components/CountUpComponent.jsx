            ...
            <div className="px-8 pb-4 text-center">
                ...
                <motion.div
                    ...
                    <div className="bg-white shadow-lg p-10 rounded-lg">
                        <h3 className="text-3xl font-semibold mb-3 text-gray-800">Users</h3>
                        <p className="text-4xl font-bold text-blue-500">
                            <CountUp end={5000} duration={3} />
                        </p>
                    </div>
                    <div className="bg-white shadow-lg p-10 rounded-lg">
                        <h3 className="text-3xl font-semibold mb-3 text-gray-800">Lessons</h3>
                        <p className="text-4xl font-bold text-green-500">
                            <CountUp end={200} duration={3} />
                        </p>
                    </div>
                    <div className="bg-white shadow-lg p-10 rounded-lg">
                        <h3 className="text-3xl font-semibold mb-3 text-gray-800">Vocabularies</h3>
